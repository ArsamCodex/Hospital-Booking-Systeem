...
import Hospital.System.repository.PatientRepository;
...
public class PatientServiceImpl implements PatientService {
    ...
    public void save(EditPatientModel editPatientModel) {
        Patient currentPatient = this.patientRepository.findOneByUserId(editPatientModel.getId());
    ...
    public PatientViewModel getById(long id) {
        Patient patient = this.patientRepository.findOneByUserId(id);
...
//
//    @Override
//    public Page<PatientViewModel> getAll(Pageable pagable) {
//        Page<Patient> patients = (Page<Patient>) this.patientRepository.findAll();
//        List<PatientViewModel> patientViewModels = new ArrayList<>();
//        for (Patient patient : patients) {
//            PatientViewModel patientViewModel = this.modelMapper.map(patient, PatientViewModel.class);
//            patientViewModels.add(patientViewModel);
//        }
//
//        return (Page<PatientViewModel>) new PageImpl(patientViewModels,pagable, patients.getTotalElements());
//    }
}
