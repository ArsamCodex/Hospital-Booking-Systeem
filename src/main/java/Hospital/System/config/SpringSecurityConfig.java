    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/", "/register-patient", "/register-doctor", "/doctors/**", "/mm_pics/**",
                        "/bootstrap/**", "/jquery/**", "/tether/**", "/font-awesome/**", "/select2/**", "/css/**","/appointment/doctor/**", "/schedule/edit", "/doctor/edit", "/doctor/patients, /doctor/edit-picture",
                        "/img/**", "/connect/**","/appointment/patient/**", "/patient/edit","/log/**").permitAll()
